...
void Round512(uint2 &p0, uint2 &p1, uint2 &p2, uint2 &p3, uint2 &p4, uint2 &p5, uint2 &p6, uint2 &p7,const int ROT0, const int ROT1, const int ROT2, const int ROT3){
...
void Round_8_512(const uint2 *const __restrict__ ks, const uint2 *const __restrict__ ts,uint2 &p0, uint2 &p1, uint2 &p2, uint2 &p3, uint2 &p4, uint2 &p5, uint2 &p6, uint2 &p7, int R){
...
__forceinline__ __device__
void Round_8_512_final(const uint2 *const __restrict__ ks, const uint2 *const __restrict__ ts,uint2 &p0, uint2 &p1, uint2 &p2, uint2 &p3, uint2 &p4, uint2 &p5, uint2 &p6, uint2 &p7){
	Round512(p0, p1, p2, p3, p4, p5, p6, p7, 46, 36, 19, 37);
	Round512(p2, p1, p4, p7, p6, p5, p0, p3, 33, 27, 14, 42);
	Round512(p4, p1, p6, p3, p0, p5, p2, p7, 17, 49, 36, 39);
	Round512(p6, p1, p0, p7, p2, p5, p4, p3, 44, 9, 54, 56);
...
void skein256_gpu_hash_32(uint32_t threads, uint32_t startNounce, uint64_t *outputHash){
	...
	if (thread < threads)
	{
		...
		Round_8_512_final(h, t, p0, p1, p2, p3, p4, p5, p6, p7);
