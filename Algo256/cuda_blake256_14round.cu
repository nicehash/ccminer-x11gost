...
static void blake256_14round_compress2nd(uint32_t *h, const uint32_t *block, const uint32_t T0)
{
	uint32_t m[16];
	uint32_t v[16];
...
void blake256_14round_gpu_hash_80(const uint32_t threads, const uint32_t startNonce, uint64_t * Hash)
{
	...
	if (thread < threads)
	{
		...
		blake256_14round_compress2nd(h, input, 640);
...
__host__
void blake256_14round_cpu_hash_80(const int thr_id, const uint32_t threads, const uint32_t startNonce, uint64_t *Hash, int order)
{
	...
	blake256_14round_gpu_hash_80 <<<grid, block>>> (threads, startNonce, Hash);
	MyStreamSynchronize(NULL, order, thr_id);
}

__host__
void blake256_14round_cpu_setBlock_80(uint32_t *pdata)
{
...
__host__
void blake256_14round_cpu_init(int thr_id, uint32_t threads)
{
