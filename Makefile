...
am__ccminer_SOURCES_DIST = elist.h miner.h compat.h compat/inttypes.h \
	...
	compat/getopt/getopt.h crc32.c ccminer.cpp pools.cpp util.cpp \
	bench.cpp bignum.cpp api.cpp hashlog.cpp nvml.cpp stats.cpp \
	sysinfos.cpp cuda.cpp Algo256/blake256.cu cuda_checkhash.cu \
	sph/blake.c sph/sha2.c sph/whirlpool.c x15/cuda_whirlpoolx.cu \
	x15/whirlpoolx.cu compat/winansi.c
am__dirstamp = $(am__leading_dot)dirstamp
#am__objects_1 = compat/ccminer-winansi.$(OBJEXT)
am_ccminer_OBJECTS = ccminer-crc32.$(OBJEXT) ccminer-ccminer.$(OBJEXT) \
	ccminer-pools.$(OBJEXT) ccminer-util.$(OBJEXT) \
	ccminer-bench.$(OBJEXT) ccminer-bignum.$(OBJEXT) \
	ccminer-api.$(OBJEXT) ccminer-hashlog.$(OBJEXT) \
	ccminer-nvml.$(OBJEXT) ccminer-stats.$(OBJEXT) \
	ccminer-sysinfos.$(OBJEXT) ccminer-cuda.$(OBJEXT) \
	Algo256/blake256.$(OBJEXT) cuda_checkhash.$(OBJEXT) \
	sph/ccminer-blake.$(OBJEXT) sph/ccminer-sha2.$(OBJEXT) \
	sph/ccminer-whirlpool.$(OBJEXT) x15/cuda_whirlpoolx.$(OBJEXT) \
	x15/whirlpoolx.$(OBJEXT) $(am__objects_1)
...
ACLOCAL = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/missing autoconf
AUTOHEADER = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/missing autoheader
AUTOMAKE = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/missing automake-1.14
AWK = mawk
CC = gcc -std=gnu99
CCAS = gcc -std=gnu99
...
CPP = gcc -std=gnu99 -E
CPPFLAGS = 
CUDA_CFLAGS = -O3 -lineno -Xcompiler -Wall
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/missing makeinfo
MKDIR_P = /bin/mkdir -p
...
WS2_LIBS = 
_libcurl_config = 
abs_builddir = /home/alexis/ccminer_Mine/ccminer_TEMP
abs_srcdir = /home/alexis/ccminer_Mine/ccminer_TEMP
abs_top_builddir = /home/alexis/ccminer_Mine/ccminer_TEMP
abs_top_srcdir = /home/alexis/ccminer_Mine/ccminer_TEMP
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /home/alexis/ccminer_Mine/ccminer_TEMP/install-sh
...
ccminer_SOURCES = elist.h miner.h compat.h compat/inttypes.h \
	...
	sysinfos.cpp cuda.cpp Algo256/blake256.cu cuda_checkhash.cu \
	sph/blake.c sph/sha2.c sph/whirlpool.c x15/cuda_whirlpoolx.cu \
	x15/whirlpoolx.cu $(am__append_1)
nvml_defs = -DUSE_WRAPNVML
nvml_libs = -ldl
ccminer_LDFLAGS = $(PTHREAD_FLAGS) -L/usr/local/cuda/lib64 -ldl
ccminer_LDADD = -L/usr/lib/x86_64-linux-gnu -lcurl -ljansson -lpthread  -lcudart -lpci -fopenmp -lcrypto -lssl -lz  $(nvml_libs)
ccminer_CPPFLAGS =  -DHAVE_PCIDEV -fopenmp $(CPPFLAGS) $(PTHREAD_FLAGS) -fno-strict-aliasing $(JANSSON_INCLUDES) $(DEF_INCLUDES) $(nvml_defs)
...
nvcc_FLAGS = $(nvcc_ARCH) -I/usr/local/cuda/include -I. -O3 -lineno -Xcompiler -Wall \
...
x15/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) x15/$(DEPDIR)
	@: > x15/$(DEPDIR)/$(am__dirstamp)
x15/cuda_whirlpoolx.$(OBJEXT): x15/$(am__dirstamp) \
	x15/$(DEPDIR)/$(am__dirstamp)
x15/whirlpoolx.$(OBJEXT): x15/$(am__dirstamp) \
	x15/$(DEPDIR)/$(am__dirstamp)
compat/$(am__dirstamp):
	@$(MKDIR_P) compat
	@: > compat/$(am__dirstamp)
